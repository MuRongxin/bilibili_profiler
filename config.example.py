...
SPAM_RELATIVE_REPEAT_FLOOR = 0.4   # 相对离群：重复率绝对下限
SPAM_RELATIVE_COUNT_FLOOR = 5      # 相对离群：弹幕数绝对下限
SPAM_RELATIVE_SCORE = 0.5          # 相对离群命中后的保底分（中档）
REPEAT_EVENT_WINDOW_SECONDS = 60   # 群体复读事件：时间窗口（秒，按真实发送时间戳）
